...
class puppet (
  ...
  $server_passengerg_high_performance = $puppet::params::server_passenger_high_performance,
  $server_passengerg_pool_idle_time   = $puppet::params::server_passenger_pool_idle_time,
